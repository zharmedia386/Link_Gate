...
class ExceedingLimit(QWidget):
   ...
   def goToOneDrive(self) :
      driver.get('https://www.microsoft.com/id-id/microsoft-365/onedrive/online-cloud-storage')
      time.sleep(0.5)
      self.close()
      print('One Drive')

   def goToDropBox(self) :
      driver.get('https://www.dropbox.com/id/')
      time.sleep(0.5)
      self.close()
      print('Drop Box')
   ...
   def setupUi(self):
      ...
      self.linkButton_1 = QPushButton('\tMultCloud')
      self.linkButton_2 = QPushButton('\tOne Drive')
      self.linkButton_3 = QPushButton('\tDrop Box')
      self.cancelButton = QPushButton('\t Close')
      
      # Set Layout horizontally
      hbox = QHBoxLayout()
      hbox.addWidget(self.linkButton_1)
      hbox.addWidget(self.linkButton_2)
      hbox.addWidget(self.linkButton_3)
      hbox.addWidget(self.cancelButton)

      # set button click event
      self.linkButton_1.clicked.connect(self.goToMultCloud)
      self.linkButton_2.clicked.connect(self.goToOneDrive)
      self.linkButton_3.clicked.connect(self.goToDropBox)
